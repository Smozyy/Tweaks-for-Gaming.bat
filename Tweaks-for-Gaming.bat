...
if "%INTERFACE%"=="" for /f "tokens=3,*" %%i in ('netsh int show interface^|find "Enabled"') do set INTERFACE=%%j
...
ECHO Disabling USB Hub powersave...
...
ECHO Disabling StorPort powersave...
...
:: Direct3d and avalon (Questionable)
